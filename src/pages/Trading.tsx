    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="flex gap-2">
          <Button variant="default" className="flex-1">Contract</Button>
          <Button variant="outline" className="flex-1">Option</Button>
          <Button variant="outline" className="flex-1">Instant Spot Trading</Button>
        </div>
